...
<br>
    <div class="py-2">
        <div class="flex justify-start">
            <a href="{{ route('estudiante.create') }}" class="p-2 ml-20 bg-green-400 hover:bg-green-500 text-white rounded shadow-lg text-xl">
                Nuevo
            </a>
        </div>
    </div>
            ...
            <table class="w-full ">
                <thead class="bg-blue-800 text-white">
                    <tr class="">
                        ...
                        <th class="text-center">Num Identidad</th>
                ...
                <tbody>
                    @foreach ($estudiantes as $estudiante)
                        <tr class="text-center">
                            ...
                            <td class=" border text-center">
                                {{ $estudiante->carrera ? $estudiante->carrera->nombre : 'N/A' }}
                            </td>

                            <td class="border p-2 w-10">
                                <div class="flex justify-center p-1 gap-4 items center text-white">
                                    <a href="{{ route('estudiante.edit',$estudiante) }}" class="bg-amber-400 flex p-3 rounded-xl">
                                    ...
                                    {{ Aire::open()->route('estudiante.destroy',$estudiante) }}
